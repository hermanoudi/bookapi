package com.hermanitto.socialbooks.client;
...
public class LivrosClient {
	...
	public LivrosClient(String url, String usuario, String senha) {
		...
		String crendencialAux = usuario + ":"+ senha;
		
		credencial = "Basic " + java.util.Base64.getEncoder().encodeToString(crendencialAux.getBytes());
